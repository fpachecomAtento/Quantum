...
var companys = mongoose.model('companys'),
	...
	crm = mongoose.model('crm'),
	fields = mongoose.model('crmField');
...
module.exports = function(req, res){
	...
	function getCrm(){
		crm.find({
			queue : constructApp.queues._id
		},function(err, resCrm){
			constructApp.crm = resCrm;
	...
	function getCrmFields(){
		fields.find({
			queue : constructApp.crm._id
		},function(err, resField){
			constructApp.fields = resField;
